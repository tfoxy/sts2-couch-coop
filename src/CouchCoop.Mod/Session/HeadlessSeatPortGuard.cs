...
internal static class HeadlessSeatPortGuard
{
    ...
    public static void ReportAndExit(SeatPortUnavailableException failure)
    {
        ...
        CouchCoopLog.Error($"[couch-coop] seat refused: assigned browser port unavailable. {detail}");
        Console.Error.WriteLine($"[couch-coop] seat refused: assigned browser port unavailable. {detail}");
        ...
        catch (Exception exception)
        {
            ...
            Console.Error.WriteLine(
                $"[couch-coop] seat port report failed: {exception.GetType().Name}: {exception.Message}");
        }
