Transforme celulares, tablets e notebooks da sua rede local em clientes de multiplayer que funcionam no navegador.

O host instala o CouchCoop. Os outros jogadores entram escaneando um código QR ou digitando a URL exibida. Eles não precisam ter Slay the Spire 2 nem o CouchCoop instalados em seus dispositivos.
...
O celular ou tablet não conecta? Veja [url=https://github.com/tfoxy/sts2-couch-coop/blob/main/workshop/discussions/brazilian/phone-connection-troubleshooting.md]Não consegue se conectar pelo celular ou tablet?[/url].
...
Encontrou um bug ou algo que não está funcionando? Veja [url=https://github.com/tfoxy/sts2-couch-coop/blob/main/workshop/discussions/brazilian/reporting-a-problem.md]Está com algum problema? Poste na discussão da Steam[/url].
