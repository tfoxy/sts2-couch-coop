...
1. Install CouchCoop on the host computer:
   ...
   - Alternatively, download the latest ZIP from [GitHub Releases](https://github.com/tfoxy/sts2-couch-coop/releases/latest) and extract it into the game's `mods` folder.
